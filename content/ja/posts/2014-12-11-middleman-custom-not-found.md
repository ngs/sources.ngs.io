...
{{< partial "2014-12-11-middleman-custom-not-found/config.rb.html.md" >}}

## lib/middleman/extensions/custom\_not\_found.rb

{{< partial "2014-12-11-middleman-custom-not-found/custom_not_found.rb.html.md" >}}

## error_page.html.slim

Slim テンプレートには以下の様な JavaScript が記述されています。

{{< partial "2014-12-11-middleman-custom-not-found/error_page.slim.html.md" >}}

HTML レンダリング結果は以下の様になります。

{{< partial "2014-12-11-middleman-custom-not-found/error_page.html.html.md" >}}
