...
ogp:
  og:
    image:
      '': 2012-11-15-everdesktop-1-0/screen1.png
      type: image/png
      width: 1280
      height: 434
alternate: true
...
[![screen1][screen1]][EverDesktop]

[EverDesktop] をリリースしました。

ディスクトップ上にあるファイルを Evernote にクリップするための、小さな Mac アプリケーションです。
...
EverDesktop はステータスバーから Mac 上の散らかったファイルを整理します。

EverDesktop は [Mac AppStore](http://s.liap.us/everdesktop) からダウンロードしてご利用いただけます。
...
[EverDesktop]: http://everdesktop.com/ja/
