...
date: 2014-05-07T01:40:00+09:00
public: true
...
{{< partial "2014-05-07-zsh-debut/01.zsh-plugins.sh.html.md" >}}

あと、rbenv プラグインはディレクトリの有無で、インストールの有無を判断しているので、Boxen が使っている、`/opt/boxen/rbenv` には対応していませんでした。

{{< partial "2014-05-07-zsh-debut/02.rbenv-plugin.sh.html.md" >}}

Symlink を貼って対応しました。

{{< partial "2014-05-07-zsh-debut/03.rbenv-symlink.sh.html.md" >}}
...
{{< partial "2014-05-07-zsh-debut/04.zsh-theme.sh.html.md" >}}

以下の様に追記しました。

{{< partial "2014-05-07-zsh-debut/05.zsh-custom.sh.html.md" >}}
