...
date: 2014-05-17T19:00:00+09:00
public: true
...
<img src="{{ asset_path(:images", "'2014-05-17-keyremap-version-control/icon.png') }}" srcset="{{ asset_path(:images", "'2014-05-17-keyremap-version-control/icon@2x.png') }} 2x">
...
<img src="{{ asset_path(:images", "'2014-05-17-keyremap-version-control/screen.png') }}" srcset="{{ asset_path(:images", "'2014-05-17-keyremap-version-control/screen@2x.png') }} 2x">
